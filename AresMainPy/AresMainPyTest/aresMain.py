...
#!Plot>>>>>>>>>>>>>
# plt.figure()
# plt.plot(posStore[0,:,2]-posStore[0,:,0])
# plt.plot(posStore[1,:,2]-posStore[1,:,0])
# plt.plot(posStore[2,:,2]-posStore[2,:,0])
# plt.legend([r"$dim1$",r"$dim2$",r"$dim3$"])
# plt.savefig('./Figure/ionStep3_2.png')

plt.figure()
plt.plot(posStore[0,:,1]-posStore[0,:,0])
plt.plot(posStore[1,:,1]-posStore[1,:,0])
plt.plot(posStore[2,:,1]-posStore[2,:,0])
plt.legend([r"$dim1$",r"$dim2$",r"$dim3$"])
