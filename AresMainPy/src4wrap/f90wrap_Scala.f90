! Module scalapack_module defined in file Scala.fpp
...
subroutine f90wrap_sl_matmat_gridcn(opa, opb, amat, bmat, cmat, am, an, bm, bn, amb, anb, bmb, bnb, cmb, cnb, n0, n1, &
    n2, n3, n4, n5)
    ...
    integer :: n5
    !f2py intent(hide), depend(cmat) :: n5 = shape(cmat,1)
    call sl_matmat_gridcn(opa=opa, opb=opb, amat=amat, bmat=bmat, cmat=cmat, am=am, an=an, bm=bm, bn=bn, amb=amb, anb=anb, &
        bmb=bmb, bnb=bnb, cmb=cmb, cnb=cnb)
end subroutine f90wrap_sl_matmat_gridcn

subroutine f90wrap_sl_matmat_gridnn(opa, opb, amat, bmat, cmat, am, an, bm, bn, amb, anb, bmb, bnb, cmb, cnb, n0, n1, &
    n2, n3, n4, n5)
    use scalapack_module, only: sl_matmat_gridnn
    implicit none
    ...
    integer :: n5
    !f2py intent(hide), depend(cmat) :: n5 = shape(cmat,1)
    call sl_matmat_gridnn(opa=opa, opb=opb, amat=amat, bmat=bmat, cmat=cmat, am=am, an=an, bm=bm, bn=bn, amb=amb, anb=anb, &
        bmb=bmb, bnb=bnb, cmb=cmb, cnb=cnb)
end subroutine f90wrap_sl_matmat_gridnn
...
subroutine f90wrap_sl_generalizeeigen_real2(dime, amat, bmat, am, an, bm, bn, amb, anb, bmb, bnb, evec, cm, cn, eval, &
    ...
    integer :: n6
    !f2py intent(hide), depend(eval) :: n6 = shape(eval,0)
    call sl_generalizeeigen_real2(dime=dime, amat=amat, bmat=bmat, am=am, an=an, bm=bm, bn=bn, amb=amb, anb=anb, bmb=bmb, &
        bnb=bnb, evec=evec, cm=cm, cn=cn, eval=eval, cmbin=cmbin, cnbin=cnbin)
end subroutine f90wrap_sl_generalizeeigen_real2
...
subroutine f90wrap_sl_matmat_realtn(opa, opb, amat, bmat, cmat, am, an, bm, bn, amb, anb, bmb, bnb, cmb, cnb, n0, n1, &
    n2, n3, n4, n5)
    ...
    integer :: n5
    !f2py intent(hide), depend(cmat) :: n5 = shape(cmat,1)
    call sl_matmat_realtn(opa=opa, opb=opb, amat=amat, bmat=bmat, cmat=cmat, am=am, an=an, bm=bm, bn=bn, amb=amb, anb=anb, &
        bmb=bmb, bnb=bnb, cmb=cmb, cnb=cnb)
end subroutine f90wrap_sl_matmat_realtn

subroutine f90wrap_sl_matmat_realnn(opa, opb, amat, bmat, cmat, am, an, bm, bn, amb, anb, bmb, bnb, cmb, cnb, n0, n1, &
    n2, n3, n4, n5)
    use scalapack_module, only: sl_matmat_realnn
    implicit none
    ...
    integer :: n5
    !f2py intent(hide), depend(cmat) :: n5 = shape(cmat,1)
    call sl_matmat_realnn(opa=opa, opb=opb, amat=amat, bmat=bmat, cmat=cmat, am=am, an=an, bm=bm, bn=bn, amb=amb, anb=anb, &
        bmb=bmb, bnb=bnb, cmb=cmb, cnb=cnb)
end subroutine f90wrap_sl_matmat_realnn
...
! End of module scalapack_module defined in file Scala.fpp
