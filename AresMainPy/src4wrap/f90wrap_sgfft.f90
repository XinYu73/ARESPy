...
subroutine f90wrap_fft(n1xy, n2xy, n3xy, nd1, nd2, nd3, z, isign, inzee, n0, n1, n2)
    ...
    call fft(n1xy=n1xy, n2xy=n2xy, n3xy=n3xy, nd1=nd1, nd2=nd2, nd3=nd3, z=z, isign=isign, inzee=inzee)
end subroutine f90wrap_fft

subroutine f90wrap_convolxc_off(n1xy, n2xy, n3xy, nd1, nd2, nd3, md1, md2, md3, nproc, iproc, pot, zf, scal, comm, n0, &
    n1, n2, n3, n4, n5)
    ...
    call convolxc_off(n1xy=n1xy, n2xy=n2xy, n3xy=n3xy, nd1=nd1, nd2=nd2, nd3=nd3, md1=md1, md2=md2, md3=md3, nproc=nproc, &
        iproc=iproc, pot=pot, zf=zf, scal=scal, comm=comm)
