...
#else
           IF (IDUMP/=0) WRITE(6,*)'ZBRENT: bracketing found'
#endif
...
#else
             IF (IDUMP>=1 ) WRITE(6,*)'ZBRENT:  can not reach accuracy'
#endif
...
#else
                IF (IDUMP>=1 ) WRITE(6,*) 'ZBRENT:  accuracy reached'
#endif
...
#else
                IF (IDUMP>=2 ) WRITE(6,*)'would go to ',A+P/QQ,P/QQ,E!}}}
#endif
...
#else
                  IF (IDUMP>=1 ) WRITE(6,*) 'ZBRENT: extrapolating'
#endif
...
#else
                  IF (IDUMP>=1 ) WRITE(6,*) 'ZBRENT: increasing intervall'
#endif
...
#else
                     IF (IDUMP>=1 ) WRITE(6,*) 'ZBRENT: interpolating'
#endif
...
#else
                    IF (IDUMP>=1 ) WRITE(6,*) 'ZBRENT: bisectioning'
#endif
