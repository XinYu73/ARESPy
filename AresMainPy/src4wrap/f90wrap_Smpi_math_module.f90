...
subroutine f90wrap_smpi_init_comm(lpbc)
    use smpi_math_module, only: smpi_init_comm
    implicit none
    
    logical, intent(in) :: lpbc
    call smpi_init_comm(lpbc=lpbc)
end subroutine f90wrap_smpi_init_comm

subroutine f90wrap_smpi_init_per
    use smpi_math_module, only: smpi_init_per
    implicit none
    
    call smpi_init_per()
end subroutine f90wrap_smpi_init_per

subroutine f90wrap_smpi_init_iso
    use smpi_math_module, only: smpi_init_iso
    implicit none
    
    call smpi_init_iso()
end subroutine f90wrap_smpi_init_iso
...
subroutine f90wrap_grid_cubic_init(n1, n2, n3, n, norder)
    use smpi_math_module, only: grid_cubic_init
    implicit none
    ...
    integer(4) :: n
    integer(4) :: norder
    call grid_cubic_init(n1=n1, n2=n2, n3=n3, n=n, norder=norder)
end subroutine f90wrap_grid_cubic_init

subroutine f90wrap_set_wrap_grid_per(myrho, wrap_box, global_n, global_n1, global_n2, n0, n1, n2, n3)
    use smpi_math_module, only: set_wrap_grid_per
    implicit none
    
    complex(8), dimension(n0) :: myrho
    complex(8), dimension(n1,n2,n3) :: wrap_box
    integer(4) :: global_n
    integer(4) :: global_n1
    integer(4) :: global_n2
    integer :: n0
    ...
    integer :: n3
    !f2py intent(hide), depend(wrap_box) :: n3 = shape(wrap_box,2)
    call set_wrap_grid_per(myrho=myrho, wrap_box=wrap_box, global_n=global_n, global_n1=global_n1, global_n2=global_n2)
end subroutine f90wrap_set_wrap_grid_per

subroutine f90wrap_set_wrap_grid_per_ata(myrho, wrap_box1d, global_n, global_n1, global_n2, n0, n1)
    use smpi_math_module, only: set_wrap_grid_per_ata
    implicit none
    ...
    call set_wrap_grid_per_ata(myrho=myrho, wrap_box1d=wrap_box1d, global_n=global_n, global_n1=global_n1, &
        global_n2=global_n2)
end subroutine f90wrap_set_wrap_grid_per_ata

subroutine f90wrap_set_wrap_grid_per_ata_real(myrho, wrap_box1d, global_n, global_n1, global_n2, n0, n1)
    use smpi_math_module, only: set_wrap_grid_per_ata_real
    implicit none
    
    real(8), dimension(n0) :: myrho
    real(8), dimension(n1) :: wrap_box1d
    integer(4) :: global_n
    integer(4) :: global_n1
    integer(4) :: global_n2
    integer :: n0
    ...
    integer :: n1
    !f2py intent(hide), depend(wrap_box1d) :: n1 = shape(wrap_box1d,0)
    call set_wrap_grid_per_ata_real(myrho=myrho, wrap_box1d=wrap_box1d, global_n=global_n, global_n1=global_n1, &
        global_n2=global_n2)
end subroutine f90wrap_set_wrap_grid_per_ata_real
