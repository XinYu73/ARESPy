...
def diagm(mat, evec, eval):
    ...
    """
    _AresMainPy_pkg.f90wrap_diagm(mat=mat, evec=evec, eval=eval)
...
def generalizeeigen(dime, mata, matb, evec, eval):
    ...
    """
    _AresMainPy_pkg.f90wrap_generalizeeigen(dime=dime, mata=mata, matb=matb, \
        evec=evec, eval=eval)
...
def orthnorm(mat):
    ...
    """
    _AresMainPy_pkg.f90wrap_orthnorm(mat=mat)
...
def norm_2(mat, k):
    ...
    """
    norm_2 = _AresMainPy_pkg.f90wrap_norm_2(mat=mat, k=k)
    return norm_2
...
def matmat(mata, matb, opa, opb, matc):
    ...
    """
    _AresMainPy_pkg.f90wrap_matmat(mata=mata, matb=matb, opa=opa, opb=opb, \
        matc=matc)
...
def invmat(mat):
    ...
    """
    _AresMainPy_pkg.f90wrap_invmat(mat=mat)
...
def orthnorm_real(mat):
    ...
    """
    _AresMainPy_pkg.f90wrap_orthnorm_real(mat=mat)
...
def diagm_real(mat, evec, eval):
    ...
    """
    _AresMainPy_pkg.f90wrap_diagm_real(mat=mat, evec=evec, eval=eval)
...
def generalizeeigen_real(dime, mata, matb, evec, eval):
    ...
    """
    _AresMainPy_pkg.f90wrap_generalizeeigen_real(dime=dime, mata=mata, matb=matb, \
        evec=evec, eval=eval)
...
def diagmx_real(mat, dime, num, il, iu, evec, eval):
    ...
    eigen-values
    """
    _AresMainPy_pkg.f90wrap_diagmx_real(mat=mat, dime=dime, num=num, il=il, iu=iu, \
        evec=evec, eval=eval)
...
def matmat_real(mata, matb, opa, opb, matc):
    ...
    """
    _AresMainPy_pkg.f90wrap_matmat_real(mata=mata, matb=matb, opa=opa, opb=opb, \
        matc=matc)
...
def cholesky_factor_real(mat):
    ...
    """
    _AresMainPy_pkg.f90wrap_cholesky_factor_real(mat=mat)
...
def invmat_real(mat):
    ...
    """
    _AresMainPy_pkg.f90wrap_invmat_real(mat=mat)
...
def get_mmax():
    ...
    """
    return _AresMainPy_pkg.f90wrap_lapack_module__get__mmax()

def set_mmax(mmax):
    _AresMainPy_pkg.f90wrap_lapack_module__set__mmax(mmax)
...
def get_nmax():
    ...
    """
    return _AresMainPy_pkg.f90wrap_lapack_module__get__nmax()

def set_nmax(nmax):
    _AresMainPy_pkg.f90wrap_lapack_module__set__nmax(nmax)
