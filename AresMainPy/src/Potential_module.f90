...
!      stop
   ...
   SUBROUTINE cal_veff_iso(rhoS,veffS)
...
#ifdef DEBUG
#ifndef MPI
      DO Is=1,rho_calc%OneDLength
         out_sphere(Is)=vh(rho_calc%x(Is),rho_calc%y(Is),rho_calc%z(Is))
      ENDDO
      open(111,file="vh_s")
      write(111,*)out_sphere(1:1000)
      close(111)

      DO Is=1,rho_calc%OneDLength
         out_sphere(Is)=grid%vlpp(rho_calc%x(Is),rho_calc%y(Is),rho_calc%z(Is))
      ENDDO
      open(111,file="vlpp_s")
      write(111,*)out_sphere(1:1000)
      close(111)

      DO Is=1,rho_calc%OneDLength
         out_sphere(Is)=vxcS(rho_calc%x(Is),rho_calc%y(Is),rho_calc%z(Is),1)
      ENDDO
      open(111,file="vxc_s")
      write(111,*)out_sphere(1:1000)
      close(111)
      ...
      write(111,*)vh(1:1000)
      close(111)
      open(111,file="vlpp_p")
      write(111,*)rho_calc%vlpp(1:1000)
      close(111)
      open(111,file="vxc_p")
      write(111,*)vxcS(1:1000,1)
      close(111)
      endif
#endif
      stop
...
#else
      COMPLEX(DP),DIMENSION(ng1,ng2,ng3) :: vlpp_recip
#endif
