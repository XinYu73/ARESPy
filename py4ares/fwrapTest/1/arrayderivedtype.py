...
class Module_Calcul(f90wrap.runtime.FortranModule):
    ...
    Defined at test.fpp lines 5-19
    ...
    class type_ptmes(f90wrap.runtime.FortranDerivedType):
        ...
        def __init__(self, handle=None):
            ...
            result = _arrayderivedtype.f90wrap_type_ptmes_initialise()
        ...
        def __del__(self):
            ...
            """
            if self._alloc:
                _arrayderivedtype.f90wrap_type_ptmes_finalise(this=self._handle)
    ...
    class array_type(f90wrap.runtime.FortranDerivedType):
        ...
        def __init__(self, handle=None):
            ...
            """
            f90wrap.runtime.FortranDerivedType.__init__(self)
            result = _arrayderivedtype.f90wrap_array_type_initialise()
            self._handle = result[0] if isinstance(result, tuple) else result
        ...
        def __del__(self):
            ...
            """
            if self._alloc:
                _arrayderivedtype.f90wrap_array_type_finalise(this=self._handle)
    ...
    def recup_point(self):
        ...
        """
        _arrayderivedtype.f90wrap_recup_point(x=self._handle)
    ...
    def xytest():
        ...
        Defined at test.fpp lines 18-19
