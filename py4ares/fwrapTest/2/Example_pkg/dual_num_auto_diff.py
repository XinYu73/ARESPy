...
@f90wrap.runtime.register_class("Example_pkg.DUAL_NUM")
class DUAL_NUM(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        result = _Example_pkg.f90wrap_dual_num_initialise()
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            _Example_pkg.f90wrap_dual_num_finalise(this=self._handle)
    ...
    def x_ad_(self):
        ...
        """
        return _Example_pkg.f90wrap_dual_num__get__x_ad_(self._handle)
    
    @x_ad_.setter
    def x_ad_(self, x_ad_):
        _Example_pkg.f90wrap_dual_num__set__x_ad_(self._handle, x_ad_)
...
def abs_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_abs_d(u=self._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def acos_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_acos_d(u=self._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def asin_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_asin_d(u=self._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def cos_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_cos_d(u=self._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def exp_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_exp_d(u=self._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def int_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_int_d(u=self._handle)
    return res
...
def log_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_log_d(u=self._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def log10_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_log10_d(u=self._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def nint_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_nint_d(u=self._handle)
    return res
...
def sin_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_sin_d(u=self._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def sqrt_d(self):
    ...
    """
    res = _Example_pkg.f90wrap_sqrt_d(u=self._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def _max_dd(self, val2, val3=None, val4=None, val5=None):
    ...
    """
    res = _Example_pkg.f90wrap_max_dd(val1=self._handle, val2=val2._handle, \
        val3=None if val3 is None else val3._handle, val4=None if val4 is None else \
        val4._handle, val5=None if val5 is None else val5._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def _max_di(self, n):
    ...
    """
    res = _Example_pkg.f90wrap_max_di(u=self._handle, n=n)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def _max_dr(self, n):
    ...
    """
    res = _Example_pkg.f90wrap_max_dr(u=self._handle, n=n)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def _max_ds(self, n):
    ...
    """
    res = _Example_pkg.f90wrap_max_ds(u=self._handle, n=n)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def _max_rd(r, u):
    ...
    """
    res = _Example_pkg.f90wrap_max_rd(r=r, u=u._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def max(*args, **kwargs):
    ...
    """
    for proc in [_max_dd, _max_di, _max_dr, _max_ds, _max_rd]:
        try:
...
def _min_dd(self, val2, val3=None, val4=None):
    ...
    """
    res = _Example_pkg.f90wrap_min_dd(val1=self._handle, val2=val2._handle, \
        val3=None if val3 is None else val3._handle, val4=None if val4 is None else \
        val4._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
...
def _min_dr(self, n):
    ...
    """
    res = _Example_pkg.f90wrap_min_dr(u=self._handle, n=n)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def _min_ds(self, n):
    ...
    """
    res = _Example_pkg.f90wrap_min_ds(u=self._handle, n=n)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def min(*args, **kwargs):
    ...
    """
    for proc in [_min_dd, _min_dr, _min_ds]:
        try:
            return proc(*args, **kwargs)
        except TypeError:
            continue
...
def _sign_dd(self, val2):
    ...
    """
    res = _Example_pkg.f90wrap_sign_dd(val1=self._handle, val2=val2._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def _sign_rd(val1, val2):
    ...
    """
    res = _Example_pkg.f90wrap_sign_rd(val1=val1, val2=val2._handle)
    res = f90wrap.runtime.lookup_class("Example_pkg.DUAL_NUM").from_handle(res, \
        alloc=True)
    return res
...
def get_ndv_ad():
    ...
    """
    return _Example_pkg.f90wrap_dual_num_auto_diff__get__ndv_ad()
