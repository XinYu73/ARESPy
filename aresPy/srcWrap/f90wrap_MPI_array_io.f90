! Module array_io defined in file MPI_array_io.f90
...
subroutine f90wrap_output_i(size_bn, array, name, n0)
    ...
    integer(8) :: size_bn
    integer(8), intent(in), dimension(n0) :: array
    character*(*) :: name
    integer :: n0
    !f2py intent(hide), depend(array) :: n0 = shape(array,0)
    call output(size=size_bn, array=array, name=name)
...
subroutine f90wrap_input_i(size_bn, array, name, n0)
    ...
    integer(8) :: size_bn
    integer(8), intent(inout), dimension(n0) :: array
    character*(*) :: name
    integer :: n0
    !f2py intent(hide), depend(array) :: n0 = shape(array,0)
    call input(size=size_bn, array=array, name=name)
...
! End of module array_io defined in file MPI_array_io.f90
