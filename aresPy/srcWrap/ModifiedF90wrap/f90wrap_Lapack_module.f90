! Module lapack_module defined in file Lapack_module.fpp
...
subroutine f90wrap_lapack_module__get__MMAX(f90wrap_MMAX)
    ...
    implicit none
    integer(4), intent(out) :: f90wrap_MMAX
...
subroutine f90wrap_lapack_module__set__MMAX(f90wrap_MMAX)
    use lapack_module, only: lapack_module_MMAX => MMAX
    implicit none
    integer(4), intent(in) :: f90wrap_MMAX
...
! End of module lapack_module defined in file Lapack_module.fpp
