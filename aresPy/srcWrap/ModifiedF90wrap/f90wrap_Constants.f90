! Module constants defined in file Constants.fpp
...
subroutine f90wrap_constants__get__inputunit(f90wrap_inputunit)
    ...
    implicit none
    integer(4), intent(out) :: f90wrap_inputunit
...
subroutine f90wrap_constants__get__errunit(f90wrap_errunit)
    ...
    implicit none
    integer(4), intent(out) :: f90wrap_errunit
...
subroutine f90wrap_constants__get__outputunit(f90wrap_outputunit)
    ...
    implicit none
    integer(4), intent(out) :: f90wrap_outputunit
...
subroutine f90wrap_constants__get__mdposunit(f90wrap_mdposunit)
    ...
    implicit none
    integer(4), intent(out) :: f90wrap_mdposunit
...
! End of module constants defined in file Constants.fpp
