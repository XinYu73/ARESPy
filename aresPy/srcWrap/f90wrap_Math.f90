! Module math defined in file Math.f90
...
subroutine f90wrap_one2three(id, n_dens, pos)
    ...
    integer(8) :: id
    integer(8), dimension(3) :: n_dens
    integer(8), dimension(3) :: pos
...
subroutine f90wrap_mat2thr(n1, n2, n3, i, ix, iy, iz, offset)
    ...
    integer(8), intent(in) :: n3
    integer(8), intent(in) :: i
    integer(8), intent(out) :: ix
    integer(8), intent(out) :: iy
    integer(8), intent(out) :: iz
    integer(8), intent(in), optional, dimension(3) :: offset
...
subroutine f90wrap_realint_sort(nev, arr, brr, crr, n0, n1, n2, n3)
    ...
    integer(8), intent(in) :: nev
    real(8), intent(inout), dimension(n0) :: arr
    integer(8), intent(inout), dimension(n1,n2) :: brr
...
subroutine f90wrap_pgfo(omat, n1, n2, n3, ix, iy, iz, ex, ey, ez)
    ...
    integer(8), intent(in) :: iy
    integer(8), intent(in) :: iz
    integer(8), intent(out) :: ex
    integer(8), intent(out) :: ey
    integer(8), intent(out) :: ez
...
subroutine f90wrap_rcsntable(n1, n2, n3, dn, h, srmax, rcs, cns, sphindx, nspt, n0, n1, n2, n3, n4, n5, n6, n7, n8)
    ...
    integer(8), intent(out) :: nspt
    integer :: n0
    !f2py intent(hide), depend(rcs) :: n0 = shape(rcs,1)
    integer :: n1
    !f2py intent(hide), depend(rcs) :: n1 = shape(rcs,2)
    integer :: n2
    !f2py intent(hide), depend(rcs) :: n2 = shape(rcs,3)
    integer :: n3
    !f2py intent(hide), depend(cns) :: n3 = shape(cns,0)
    integer :: n4
...
subroutine f90wrap_rcsntable_atoms(n1, n2, n3, dn, na, h, poscar, srmax, atomr, rvec, rcs, cns, sphindx, nspt, n0, n1, &
    ...
    integer :: n1
    !f2py intent(hide), depend(rvec) :: n1 = shape(rvec,1)
    integer :: n2
    !f2py intent(hide), depend(rvec) :: n2 = shape(rvec,2)
    integer :: n3
    !f2py intent(hide), depend(rvec) :: n3 = shape(rvec,3)
    integer :: n4
...
subroutine f90wrap_integer_index(array, n, id, n0, n1)
    ...
    integer(8), dimension(n0) :: array
    integer(8) :: n
    integer(8), dimension(n1) :: id
    integer :: n0
...
! End of module math defined in file Math.f90
