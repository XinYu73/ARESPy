...
subroutine f90wrap_ewald_energy(latticev, ionpositions, iontpid, ret_ewald_energy, ioncharges, n0, n1, n2, n3, n4)
    use ewald, only: ewald_energy
    implicit none
    
    real(8), intent(in), dimension(3,n0) :: latticev
    real(8), intent(in), dimension(n1,n2) :: ionpositions
    integer(4), intent(in), dimension(n3) :: iontpid
    real(8), intent(out) :: ret_ewald_energy
    real(8), intent(in), dimension(n4) :: ioncharges
    integer :: n0
    !f2py intent(hide), depend(latticev) :: n0 = shape(latticev,1)
    integer :: n1
    !f2py intent(hide), depend(ionpositions) :: n1 = shape(ionpositions,0)
    integer :: n2
    !f2py intent(hide), depend(ionpositions) :: n2 = shape(ionpositions,1)
    integer :: n3
    !f2py intent(hide), depend(iontpid) :: n3 = shape(iontpid,0)
    integer :: n4
...
subroutine f90wrap_iso_ewald_forces(latticev, ionpositions, iontpid, ret_iso_ewald_forces, ioncharges, n0, n1, n2, n3, &
    ...
    real(8), intent(in), dimension(n1,n2) :: ionpositions
    integer(4), intent(in), dimension(n3) :: iontpid
    real(8), intent(out), dimension(3,n4) :: ret_iso_ewald_forces
    real(8), intent(in), dimension(n5) :: ioncharges
    integer :: n0
    !f2py intent(hide), depend(latticev) :: n0 = shape(latticev,1)
    integer :: n1
    !f2py intent(hide), depend(ionpositions) :: n1 = shape(ionpositions,0)
    ...
    integer :: n4
    integer :: n5
    !f2py intent(hide), depend(ioncharges) :: n5 = shape(ioncharges,0)
...
subroutine f90wrap_ewald_forces(latticev, ionpositions, iontpid, ret_ewald_forces, ioncharges, n0, n1, n2, n3, n4, n5)
    ...
    real(8), intent(in), dimension(n1,n2) :: ionpositions
    integer(4), intent(in), dimension(n3) :: iontpid
    real(8), intent(out), dimension(3,n4) :: ret_ewald_forces
    real(8), intent(in), dimension(n5) :: ioncharges
    integer :: n0
    !f2py intent(hide), depend(latticev) :: n0 = shape(latticev,1)
    integer :: n1
...
subroutine f90wrap_ewald_stress(latticev, ionpositions, iontpid, ret_ewald_stress, ioncharges, n0, n1, n2, n3, n4, n5)
    ...
    real(8), intent(in), dimension(n1,n2) :: ionpositions
    integer(4), intent(in), dimension(n3) :: iontpid
    real(8), intent(out), dimension(3,n4) :: ret_ewald_stress
    real(8), intent(in), dimension(n5) :: ioncharges
    integer :: n0
    !f2py intent(hide), depend(latticev) :: n0 = shape(latticev,1)
    integer :: n1
...
subroutine f90wrap_ewaldrpstr(ret_ewaldrpstr, eta, n0)
    use ewald, only: ewaldrpstr
    implicit none
    
    real(8), intent(out), dimension(3,n0) :: ret_ewaldrpstr
    real(8) :: eta
    integer :: n0
    ret_ewaldrpstr = ewaldrpstr(eta=eta)
end subroutine f90wrap_ewaldrpstr

subroutine f90wrap_ewaldavstr(ret_ewaldavstr, eta, n0)
    use ewald, only: ewaldavstr
    implicit none
    
    real(8), intent(out), dimension(3,n0) :: ret_ewaldavstr
    real(8) :: eta
    integer :: n0
