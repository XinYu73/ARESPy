...
subroutine f90wrap_smpi_diff_init_sph(n1, n2, n3, n, norder, cell_mu, lsp, n0, n11, n22)
    ...
    integer :: n11
    !f2py intent(hide), depend(lsp) :: n11 = shape(lsp,1)
    integer :: n22
    !f2py intent(hide), depend(lsp) :: n22 = shape(lsp,2)
