...
Defined at Fourier.fpp lines 5-504
...
def planfft(dimx, dimy, dimz, lsp):
    ...
    Defined at Fourier.fpp lines 72-155
    ...
    ------------------------------------------------------------------------------
    """
    _arespy_pkg.f90wrap_planfft(dimx=dimx, dimy=dimy, dimz=dimz, lsp=lsp)
...
def planfst(dimx, dimy, dimz):
    ...
    Defined at Fourier.fpp lines 157-189
    ...
    ------------------------------------------------------------------------------
    """
    _arespy_pkg.f90wrap_planfst(dimx=dimx, dimy=dimy, dimz=dimz)
...
def getfftdims():
    ...
    Defined at Fourier.fpp lines 191-218
    ...
    ------------------------------------------------------------------------------
    """
    dimx, dimy, dimz = _arespy_pkg.f90wrap_getfftdims()
...
def getfftcomplexdims():
    ...
    Defined at Fourier.fpp lines 220-247
    ...
    ------------------------------------------------------------------------------
    """
    dimx, dimy, dimz = _arespy_pkg.f90wrap_getfftcomplexdims()
    return dimx, dimy, dimz
...
def forwardfst(array):
    ...
    Defined at Fourier.fpp lines 418-443
    ...
    ------------------------------------------------------------------------------
    """
    _arespy_pkg.f90wrap_forwardfst(array=array)
...
def backfst(array):
    ...
    Defined at Fourier.fpp lines 445-468
    ...
    ------------------------------------------------------------------------------
    """
    _arespy_pkg.f90wrap_backfst(array=array)
...
def cleanfft():
    ...
    Defined at Fourier.fpp lines 470-504
...
def _forwardfft_4d(array):
    ...
    Defined at Fourier.fpp lines 249-292
    ...
    ------------------------------------------------------------------------------
    """
    transform = _arespy_pkg.f90wrap_forwardfft_4d(array=array)
    return transform
...
def _backfft_4d(array):
    ...
    Defined at Fourier.fpp lines 294-335
    ...
    ------------------------------------------------------------------------------
    """
    transform = _arespy_pkg.f90wrap_backfft_4d(array=array)
    return transform
...
def _forwardfft_3d(array):
    ...
    Defined at Fourier.fpp lines 337-375
    ...
    ------------------------------------------------------------------------------
    """
    transform = _arespy_pkg.f90wrap_forwardfft_3d(array=array)
    return transform
...
def _backfft_3d(array):
    ...
    Defined at Fourier.fpp lines 377-416
    ...
    ------------------------------------------------------------------------------
    """
    transform = _arespy_pkg.f90wrap_backfft_3d(array=array)
    return transform
...
def fft(*args, **kwargs):
    ...
    Defined at Fourier.fpp lines 65-69
...
def get_offset():
    ...
    Defined at Fourier.fpp line 60
    
    """
    return _arespy_pkg.f90wrap_fourier__get__offset()

def set_offset(offset):
    _arespy_pkg.f90wrap_fourier__set__offset(offset)
