! Module fourier defined in file Fourier.f90

subroutine f90wrap_planfft(dimx, dimy, dimz, lsp, n0, n1, n2)
    use fourier, only: planfft
    implicit none
    
    integer(8), intent(in) :: dimx
    integer(8), intent(in) :: dimy
    integer(8), intent(in) :: dimz
    ...
    call planfft(dimX=dimx, dimY=dimy, dimZ=dimz, lsp=lsp)
...
subroutine f90wrap_getfftdims(dimx, dimy, dimz)
    ...
    integer(8), intent(out) :: dimx
    integer(8), intent(out) :: dimy
    integer(8), intent(out) :: dimz
...
subroutine f90wrap_fourier__get__offset(f90wrap_offset)
    ...
    implicit none
    integer(8), intent(out) :: f90wrap_offset
...
subroutine f90wrap_fourier__set__offset(f90wrap_offset)
    use fourier, only: fourier_offset => offset
    implicit none
    integer(8), intent(in) :: f90wrap_offset
    
    fourier_offset = f90wrap_offset
end subroutine f90wrap_fourier__set__offset

! End of module fourier defined in file Fourier.f90
