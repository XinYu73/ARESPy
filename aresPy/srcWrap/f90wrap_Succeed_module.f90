! Module succeed defined in file Succeed_module.f90
...
subroutine f90wrap_get_psi(nrho, n_s, nspin, psi_new, n0, n1, n2)
    ...
    integer(8), intent(in) :: nrho
    integer(8), intent(in) :: n_s
    integer(8), intent(in) :: nspin
...
subroutine f90wrap_cal_trans_phase(nr, nspin, r_new, n1, n2, n3, ng1, ng2, ng3, gvec, trans_phase, n0, n1, n2, n3, n4, &
    ...
    integer(8), intent(in) :: ng1
    integer(8), intent(in) :: ng2
    integer(8), intent(in) :: ng3
...
subroutine f90wrap_succeed__get__counter1(f90wrap_counter1)
    ...
    implicit none
    integer(8), intent(out) :: f90wrap_counter1
...
subroutine f90wrap_succeed__set__counter1(f90wrap_counter1)
    use succeed, only: succeed_counter1 => counter1
    implicit none
    integer(8), intent(in) :: f90wrap_counter1
...
subroutine f90wrap_succeed__get__counter2(f90wrap_counter2)
    ...
    implicit none
    integer(8), intent(out) :: f90wrap_counter2
...
subroutine f90wrap_succeed__set__counter2(f90wrap_counter2)
    use succeed, only: succeed_counter2 => counter2
    implicit none
    integer(8), intent(in) :: f90wrap_counter2
...
subroutine f90wrap_succeed__get__counter3(f90wrap_counter3)
    ...
    implicit none
    integer(8), intent(out) :: f90wrap_counter3
...
subroutine f90wrap_succeed__set__counter3(f90wrap_counter3)
    use succeed, only: succeed_counter3 => counter3
    implicit none
    integer(8), intent(in) :: f90wrap_counter3
...
! End of module succeed defined in file Succeed_module.f90
