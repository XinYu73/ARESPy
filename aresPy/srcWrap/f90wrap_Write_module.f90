! Module write_module defined in file Write_module.f90
...
subroutine f90wrap_write3dpencil(filename, rho, n0, n1, n2)
    use write_module, only: write3dpencil
    implicit none
    ...
    integer :: n2
    !f2py intent(hide), depend(rho) :: n2 = shape(rho,2)
    call write3dpencil(filename=filename, rho=rho)
end subroutine f90wrap_write3dpencil
...
! End of module write_module defined in file Write_module.f90
