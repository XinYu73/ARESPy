! Module scf_module defined in file Scf_module.f90
...
subroutine f90wrap_scf_module__get__IWD(f90wrap_IWD)
    ...
    implicit none
    integer(8), intent(out) :: f90wrap_IWD
...
subroutine f90wrap_scf_module__set__IWD(f90wrap_IWD)
    use scf_module, only: scf_module_IWD => IWD
    implicit none
    integer(8), intent(in) :: f90wrap_IWD
...
! End of module scf_module defined in file Scf_module.f90
