! Module arpack_module defined in file Arpack_module.f90
...
subroutine f90wrap_real_diagh_arpack(n, veff, nev, evec, eval, resid_restart, nec, info, maxmvs, tol, n0, n1, n2, n3, &
    ...
    integer(8), intent(inout) :: nec
    integer(8), intent(inout) :: info
    integer(8), intent(inout) :: maxmvs
...
subroutine f90wrap_arpack_module__get__maxn(f90wrap_maxn)
    ...
    implicit none
    integer(8), intent(out) :: f90wrap_maxn
...
subroutine f90wrap_arpack_module__set__maxn(f90wrap_maxn)
    use arpack_module, only: arpack_module_maxn => maxn
    implicit none
    integer(8), intent(in) :: f90wrap_maxn
...
subroutine f90wrap_arpack_module__get__maxnev(f90wrap_maxnev)
    ...
    implicit none
    integer(8), intent(out) :: f90wrap_maxnev
...
subroutine f90wrap_arpack_module__set__maxnev(f90wrap_maxnev)
    use arpack_module, only: arpack_module_maxnev => maxnev
    implicit none
    integer(8), intent(in) :: f90wrap_maxnev
...
subroutine f90wrap_arpack_module__get__maxncv(f90wrap_maxncv)
    ...
    implicit none
    integer(8), intent(out) :: f90wrap_maxncv
...
subroutine f90wrap_arpack_module__set__maxncv(f90wrap_maxncv)
    use arpack_module, only: arpack_module_maxncv => maxncv
    implicit none
    integer(8), intent(in) :: f90wrap_maxncv
...
! End of module arpack_module defined in file Arpack_module.f90
