! Module mathsplines defined in file MathSplines.f90
...
subroutine f90wrap_rvec_bracket(n, x, xval, left, right, n0)
    ...
    integer(8), intent(out) :: left
    integer(8), intent(out) :: right
    integer :: n0
...
! End of module mathsplines defined in file MathSplines.f90
