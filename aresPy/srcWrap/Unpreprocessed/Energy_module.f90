...
#else
      PRINT*,'Total times(s)',(time_total1-time_total0)/10000._DP
      PRINT*,'SCF   times(s)',(time_scf1-time_scf0)/10000._DP
#endif
      PRINT*,'-----------------------------------------------------'
