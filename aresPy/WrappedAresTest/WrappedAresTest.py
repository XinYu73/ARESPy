...
print(aresParameters.system_name.decode('utf-8'))
print(aresParameters.cellfile_name.decode('utf-8'))
print(aresParameters.ppfile_name) # !why an array 

print(aresParameters.ecut)
...
print(aresParameters.ntype)

aresstruct_module=ares.Struct_Module()
temp = aresstruct_module.struct_type()
print(temp.stress)
